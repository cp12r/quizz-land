const BADGES = [
  ...
  { id: 'tryhard', label: 'Tryhard', icon: 'T', tone: '#ffd54a' },
  ...
  { id: 'no-brain', label: 'No Brain', icon: 'N', tone: '#ff8f3d' },
  { id: 'speed-demon', label: 'Speed Demon', icon: 'V', tone: '#39d5ff' },
  { id: 'comeback-king', label: 'Comeback King', icon: 'K', tone: '#36d27c' },
