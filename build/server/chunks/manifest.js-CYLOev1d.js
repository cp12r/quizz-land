...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./0-gB7dBTDG.js')),
			__memo(() => import('./1-Gs-TEN2f.js')),
			__memo(() => import('./2-qY8OCOaa.js')),
			__memo(() => import('./3-Couwg4sv.js')),
			__memo(() => import('./4-DLul-IAx.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./_server-C96gPS4I.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./_server-Dk0B-Whm.js'))
			},
			{
				...
				params: [{"name":"roomId","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./_server-Dp7popZN.js'))
			},
			{
				id: "/results/[roomId]",
				pattern: /^\/results\/([^/]+?)\/?$/,
...
//# sourceMappingURL=manifest.js-CYLOev1d.js.map
